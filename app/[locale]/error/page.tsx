    ...
    switch (errorType) {
      case "database":
        return {
          ...
          suggestions: [
            t('database.suggestions.0'),
            t('database.suggestions.1'),
            t('database.suggestions.2'),
            t('database.suggestions.3'),
            t('database.suggestions.4'),
          ],
          buttonText: t('database.buttonText'),
        };
      default:
        return {
          icon: AlertTriangle,
          ...
          suggestions: [
            t('general.suggestions.0'),
            t('general.suggestions.1'),
            t('general.suggestions.2'),
            t('general.suggestions.3'),
          ],
          buttonText: t('general.buttonText'),
        };
    }
  };
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono">{timestamp || t('loading')}</span>
                </div>
                <div className="flex justify-between">
