-- Migration: Add Unified Notification System
-- Run this migration to add the unified notification system for all roles
...
-- GRANT ALL ON TABLE "Notification" TO authenticated;
